...
from apps.views_core import (
    propositions_cellule, changer_statut_proposition, rejoindre_cellule,
...
urlpatterns = [
    ...
    path('api/v1/cellules/<slug:slug>/rejoindre', rejoindre_cellule),
    ...
    path('api/v1/me/', me),
    path('api/v1/me/mot-de-passe', changer_mot_de_passe),
