...
const mocks = {
  ...
  cellules: [
    { id: 'web', nom: 'Cellule Web', icone: '💻', couleur: '#1FAF72', membres: 14, description: 'Développement front & back : React, Django, déploiement. Le club construit ses propres outils ici.', programme: "Ce que tu y apprendras :\n• React + Vite, Material UI\n• Python / Django / API REST\n• Git, déploiement cloud\n\nProjet phare : cette plateforme !", image: '/photos/web.jpg' },
    { id: 'ia', nom: 'Cellule IA', icone: '🤖', couleur: '#2563EB', membres: 9, description: "Intelligence artificielle et données : modèles, ateliers Python, projets d'agents.", programme: "Ce que tu y apprendras :\n• Bases de Python data\n• LLMs, prompts, agents IA\n• Mini-projets encadrés\n\nProjet phare : assistant IA du club.", image: '/photos/ia.jpg' },
    { id: 'cyber', nom: 'Cellule Cybersécurité', icone: '🛡️', couleur: '#0F5B3A', membres: 11, description: "Sécurité offensive & défensive : CTF, bonnes pratiques, sensibilisation de l'école.", programme: "Ce que tu y apprendras :\n• Bases Linux & réseaux\n• Challenges CTF débutants\n• Sécurité au quotidien\n\nÉvénement : 1er CTF interne EMSP.", image: '/photos/cyber.jpg' },
    { id: 'design', nom: 'Cellule Design', icone: '🎨', couleur: '#7B61FF', membres: 7, description: 'UI/UX, identité visuelle, montage vidéo — tout ce qui rend le club visible.', programme: "Ce que tu y apprendras :\n• Figma & design system\n• Montage vidéo (bannières du club)\n• Charte graphique\n\nProjet : habillage vidéo des événements.", image: '/photos/design.jpg' },
  ],
  activites: [
